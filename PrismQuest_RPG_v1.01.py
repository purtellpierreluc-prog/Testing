                    ...
                    with ui.element('div').classes('mq-town-dashboard w-full'):
                            ...
                            with ui.element('div').classes('mq-town-route-groups w-full mt-4'):
                                with ui.element('div').classes('mq-town-route-group social'):
                                    with ui.element('div').classes('mq-route-grid w-full mt-4'):
                                        ...
                                        ui.button('Settings', on_click=lambda: (state.open_game_tab('settings', 'You open a quieter ledger of personal settings and audio balances.'), request_render_refresh())).classes('mq-route-btn')
                        ...
                        with ui.card().classes('mq-log mq-town-comm-card p-4'):
                            ...
                            with ui.element('div').classes('mq-comm-bubble mt-4'):
                                ui.label(hint).classes('mq-town-crier-ledger italic whitespace-pre-line')
                                ui.separator().classes('my-3 opacity-20')
