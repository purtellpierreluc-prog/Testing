                    ...
                    if state.game_tab == 'inventory':
                        ...
                        with ui.column().classes('w-full gap-4'):
                            with ui.card().classes('mq-card w-full p-5'):
                                ...
                                ui.label('The registrar now ranks every signed-in account by the highest class reached, then by level inside that class. Fighter and Mage are treated as equal feeder classes, so level breaks ties between them.').classes('text-slate-300 leading-7 mt-2')
                                with ui.card().classes('mq-panel-frame p-4 mt-4'):
                            ...
                            with ui.card().classes('mq-card w-full p-4'):
                                ...
                                if not rows:
                                    ...
                                    ui.table(columns=[
                                        ...
                                        {'name':'masterquest_attempts','label':'PQ Attempts','field':'masterquest_attempts'},
