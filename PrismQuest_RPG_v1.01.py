...
TITLE_SCREEN_TRANSLATIONS: Dict[str, Dict[str, str]] = {
    'en': {
        ...
        'restore_title_art_hint': 'Place Title Screen.png into Assets to restore the original title art.',
        'title_art_alt': 'Prismatic Quest title art',
        'title_caption': 'Enter the ledger, bind your account, and wake the chronicle that will carry your climb.',
        'chronicle_caption': 'Choose the chronicle that will advance this account.',
        'account_cloud_saves': 'Account & Cloud Saves',
        'signed_in_as': 'Signed in as {email}.',
        'signed_in_ledger_hint': 'Your chronicle ledger now lives behind this account. Open the slots screen to choose which hero continues the climb.',
        'create_signin_hint': 'Create an account or sign in to make your chronicle slots private and persistent across devices.',
        'email': 'Email',
        'password': 'Password',
        'email_confirmation_note': 'Email confirmation may be required the first time you sign up.',
        'create_account': 'Create Account',
        'sign_in': 'Sign In',
        'open_chronicle_slots': 'Open Chronicle Slots',
        'sign_out': 'Sign Out',
        'discord_login_hint': 'Or connect with Discord for a one-tap cloud chronicle login.',
        'sign_in_with_discord': 'Sign In with Discord',
        'local_slots_only': 'Supabase is not configured, so this build still uses local chronicle slots only.',
        'community_server': 'Community Server',
        'community_description': 'Join the official community Discord to share builds, talk balance, and follow updates.',
        'open_community_discord': 'Open Community Discord',
        'language_accessibility': 'Language & Accessibility',
        'language_label': 'Language',
        'accessibility_intro': 'These settings apply immediately on this device and make the title screen easier to read.',
...
def normalize_ui_language(raw_value: object) -> str:
    key = str(raw_value or '').strip()
    return key if key in UI_LANGUAGE_LABELS else DEFAULT_UI_LANGUAGE


def localized_title_text(language: object, key: str, **kwargs: object) -> str:
    lang_key = normalize_ui_language(language)
    base = TITLE_SCREEN_TRANSLATIONS.get(DEFAULT_UI_LANGUAGE, {})
    bundle = TITLE_SCREEN_TRANSLATIONS.get(lang_key, base)
    template = str(bundle.get(key) or base.get(key) or key)
    if kwargs:
...
def normalize_player_class_name(value: object, default: str = 'Black Guard') -> str:
    ...
    return mapped if mapped in CLASS_ORDER else default
...
.mq-page.mq-a11y-large-text label,
.mq-page.mq-a11y-large-text .q-btn,
.mq-page.mq-a11y-large-text .q-field__native,
.mq-page.mq-a11y-large-text .q-field__label,
.mq-page.mq-a11y-large-text input,
.mq-page.mq-a11y-large-text textarea,
.mq-page.mq-a11y-large-text .q-checkbox__label {
  font-size: 1.58rem !important;
}
.mq-page.mq-a11y-large-text .mq-panel-caption,
.mq-page.mq-a11y-large-text .mq-section-title,
.mq-page.mq-a11y-large-text .mq-title-caption,
.mq-page.mq-a11y-large-text .mq-stat-chip-label,
.mq-page.mq-a11y-large-text .mq-route-btn,
.mq-page.mq-a11y-large-text .mq-arena-btn,
.mq-page.mq-a11y-large-text .mq-btn-gold,
.mq-page.mq-a11y-large-text .mq-btn-secondary,
.mq-page.mq-a11y-large-text .mq-btn-affirm,
.mq-page.mq-a11y-large-text .mq-btn-warn,
.mq-page.mq-a11y-large-text .mq-btn-danger,
.mq-page.mq-a11y-large-text .mq-masterquest-chip {
  font-size: 1.26rem !important;
}
.mq-page.mq-a11y-high-contrast {
  --mq-panel-bg: rgba(5, 7, 11, 0.95);
  --mq-text-main: #ffffff;
  --mq-text-soft: #f8fafc;
  --mq-text-muted: #e5e7eb;
  --mq-scene-glow: rgba(var(--mq-accent-rgb), 0.22);
}
.mq-page.mq-a11y-high-contrast .mq-card,
.mq-page.mq-a11y-high-contrast .mq-side-card,
.mq-page.mq-a11y-high-contrast .mq-slot-card,
.mq-page.mq-a11y-high-contrast .mq-selection-hero,
.mq-page.mq-a11y-high-contrast .mq-selection-card,
.mq-page.mq-a11y-high-contrast .mq-town-header,
.mq-page.mq-a11y-high-contrast .mq-scene-card,
.mq-page.mq-a11y-high-contrast .mq-overview-card,
.mq-page.mq-a11y-high-contrast .mq-travel-card,
.mq-page.mq-a11y-high-contrast .mq-arena-card,
.mq-page.mq-a11y-high-contrast .mq-panel,
.mq-page.mq-a11y-high-contrast .mq-panel-frame,
.mq-page.mq-a11y-high-contrast .mq-log {
  border-color: rgba(255,255,255,0.24) !important;
  box-shadow: 0 20px 44px rgba(0,0,0,0.42), inset 0 1px 0 rgba(255,255,255,0.07);
}
.mq-page.mq-a11y-high-contrast .mq-title-caption {
  background: rgba(0, 0, 0, 0.82);
  border-color: rgba(255,255,255,0.28);
}
.mq-page.mq-a11y-reduce-motion *,
.mq-page.mq-a11y-reduce-motion *::before,
.mq-page.mq-a11y-reduce-motion *::after {
  animation: none !important;
  transition: none !important;
  scroll-behavior: auto !important;
}
.mq-page.mq-lang-zh-Hans,
.mq-page.mq-lang-zh-Hans label,
.mq-page.mq-lang-zh-Hans input,
.mq-page.mq-lang-zh-Hans textarea,
.mq-page.mq-lang-zh-Hans .q-btn {
...
LADDER_PLAYER_VIEWS = ['Progression', 'Fastest PQ', 'Fastest PQ by Class']
...
def normalize_pq_ledger_entry(raw_entry: object) -> Optional[Dict[str, object]]:
    if not isinstance(raw_entry, dict):
        return None
    entry_id = str(raw_entry.get('id') or '').strip()
    if not entry_id:
        return None
    character_name = clean_character_name(str(raw_entry.get('character_name') or 'Nameless Hero'))
    player_class = normalize_player_class_name(raw_entry.get('player_class'), str(raw_entry.get('player_class') or 'Black Guard'))
    mode = normalize_ladder_mode(raw_entry.get('mode'), 'Core')
    try:
        level = max(1, int(raw_entry.get('level', 1) or 1))
    except Exception:
        level = 1
    try:
        slot_index = max(1, int(raw_entry.get('slot_index', 1) or 1))
    except Exception:
        slot_index = 1
    ...
    elapsed_seconds = _coerce_fastest_pq_seconds(raw_entry.get('elapsed_seconds'))
    completed_at = str(raw_entry.get('completed_at') or '').strip() or _pq_ledger_iso_now()
    updated_at = str(raw_entry.get('updated_at') or '').strip() or completed_at
    user_id = str(raw_entry.get('user_id') or '').strip()
    try:
        attempt_index = max(0, int(raw_entry.get('attempt_index', 0) or 0))
    except Exception:
        attempt_index = 0
    return {
        'id': entry_id,
...
def normalize_pq_ledger_entries(raw_entries: object) -> List[Dict[str, object]]:
    rows: List[Dict[str, object]] = []
    if isinstance(raw_entries, list):
        for raw_entry in raw_entries[-4000:]:
            normalized = normalize_pq_ledger_entry(raw_entry)
            if normalized is not None:
                rows.append(normalized)
    rows.sort(key=lambda row: (str(row.get('completed_at') or ''), int(row.get('attempt_index', 0) or 0), str(row.get('id') or '')))
    return rows[-4000:]


def filtered_pq_ledger_rows(rows: object, mode: object, current_global_season_id: object = DEFAULT_LADDER_SEASON_ID) -> List[Dict[str, object]]:
    normalized_mode = normalize_ladder_mode(mode)
    season_id = sanitize_ladder_season_id(current_global_season_id, DEFAULT_LADDER_SEASON_ID)
    output: List[Dict[str, object]] = []
    for raw_row in normalize_pq_ledger_entries(rows):
        if normalize_ladder_mode(raw_row.get('mode'), normalized_mode) != normalized_mode:
            continue
        if slot_uses_global_ladder(normalized_mode) and sanitize_ladder_season_id(raw_row.get('season_id', season_id), season_id) != season_id:
            continue
        output.append(dict(raw_row))
    output.sort(key=lambda row: (str(row.get('completed_at') or ''), int(row.get('attempt_index', 0) or 0), str(row.get('id') or '')), reverse=True)
    return output


def local_pq_ledger_rows_for_slots(slots: object, current_global_season_id: object = DEFAULT_LADDER_SEASON_ID) -> List[Dict[str, object]]:
    season_id = sanitize_ladder_season_id(current_global_season_id, DEFAULT_LADDER_SEASON_ID)
    output: List[Dict[str, object]] = []
    if isinstance(slots, list):
        for slot_index, raw_slot in enumerate(slots, start=1):
            ...
            slot_season_id = season_id if slot_uses_global_ladder(mode) else sanitize_ladder_season_id(slot.get('season_id', DEFAULT_LADDER_SEASON_ID), DEFAULT_LADDER_SEASON_ID)
            for raw_entry in normalize_pq_ledger_entries(slot.get('pq_ledger_entries', [])):
                entry = dict(raw_entry)
                entry['slot_index'] = slot_index
                entry['mode'] = normalize_ladder_mode(entry.get('mode'), mode)
                entry['season_id'] = sanitize_ladder_season_id(entry.get('season_id', slot_season_id), slot_season_id)
                output.append(entry)
    output.sort(key=lambda row: (str(row.get('completed_at') or ''), int(row.get('attempt_index', 0) or 0), str(row.get('id') or '')), reverse=True)
    return output
...
def normalize_slot_payload(raw_slot: object) -> Dict[str, object]:
    ...
    if not isinstance(raw_slot, dict):
        return slot
    raw_player = raw_slot.get('player') if isinstance(raw_slot.get('player'), dict) else None
    if isinstance(raw_player, dict):
        raw_player = copy.deepcopy(raw_player)
        raw_player['player_class'] = normalize_player_class_name(raw_player.get('player_class'), str(raw_player.get('player_class') or 'Black Guard'))
    slot['player'] = raw_player
    ...
    slot['pq_ledger_entries'] = normalize_pq_ledger_entries(raw_slot.get('pq_ledger_entries', []))
    return slot
...
def _slot_player_metadata(slot: Dict[str, object]) -> Tuple[Optional[str], Optional[str], int, int]:
    ...
    return (
        ...
        normalize_player_class_name(player_data.get('player_class'), str(player_data.get('player_class') or 'Black Guard')) or None,
...
MASTERQUEST_ESSENCE_KEYS = ['essence_one', 'essence_two', 'essence_three', 'essence_four', 'essence_five', 'essence_six']
MASTERQUEST_ESSENCE_LABELS = {
    ...
    'essence_six': 'Essence VI',
}
MASTERQUEST_VESSEL_KEYS = ['vessel_one', 'vessel_two', 'vessel_three', 'vessel_four', 'vessel_five', 'vessel_six']
...
MASTERQUEST_VESSEL_DESCRIPTIONS = {
    ...
    'vessel_five': 'A final dark vessel, severe and patient, reserved for the penultimate true answer.',
    'vessel_six': 'A sixth black vessel lingers beyond the others, demanding the final true light.',
}
...
def slot_fastest_pq_seconds(slot: Dict[str, object]) -> Optional[float]:
    normalized = normalize_slot_payload(slot)
    ledger_entries = normalize_pq_ledger_entries(normalized.get('pq_ledger_entries', []))
    best: Optional[float] = None
    for entry in ledger_entries:
        elapsed = _coerce_fastest_pq_seconds(entry.get('elapsed_seconds'))
        if elapsed is None:
            continue
    ...
    if isinstance(stats, dict):
        for class_name, class_stats in stats.items():
            ...
            try:
                ...
                continue
            if best is None or fastest_value < best:
                best = fastest_value
    return best
...
def _leaderboard_identity_key(row: object) -> str:
    if not isinstance(row, dict):
        return ''
    ...
    mode = normalize_ladder_mode(row.get('mode'), '')
    return f'name:{mode}:{name}' if name else ''

def _leaderboard_updated_sort_value(row: object) -> str:
    if not isinstance(row, dict):
        return ''
    return str(row.get('updated_at') or '').strip()


def _coerce_fastest_pq_seconds(value: object) -> Optional[float]:
    if value in (None, ''):
        return None
    try:
...
def _merge_leaderboard_fastest_time(current_payload: Dict[str, object], existing_rows: object) -> Dict[str, object]:
    merged = dict(current_payload)
    best_fastest = _coerce_fastest_pq_seconds(merged.get('fastest_pq_seconds'))
    if isinstance(existing_rows, list):
        for raw_row in existing_rows:
            if not isinstance(raw_row, dict):
                continue
            existing_fastest = _coerce_fastest_pq_seconds(raw_row.get('fastest_pq_seconds'))
            if existing_fastest is None:
                continue
            if best_fastest is None or existing_fastest < best_fastest:
                best_fastest = existing_fastest
    merged['fastest_pq_seconds'] = best_fastest
    return merged

def ladder_fastest_overall_rows(rows: object, mode: object, current_global_season_id: object = DEFAULT_LADDER_SEASON_ID) -> List[Dict[str, object]]:
    best_by_user: Dict[str, Dict[str, object]] = {}
    for row in filtered_pq_ledger_rows(rows, mode, current_global_season_id):
        elapsed = _coerce_fastest_pq_seconds(row.get('elapsed_seconds'))
        if elapsed is None:
            continue
        identity_key = _leaderboard_identity_key({'user_id': row.get('user_id'), 'character_name': row.get('character_name'), 'mode': row.get('mode')})
        if not identity_key:
            continue
        candidate = {
            'user_id': row.get('user_id'),
            'character_name': row.get('character_name'),
            'highest_class': row.get('player_class'),
            'player_class': row.get('player_class'),
            'level': int(row.get('level', 1) or 1),
            'mode': normalize_ladder_mode(row.get('mode'), normalize_ladder_mode(mode)),
            'season_id': sanitize_ladder_season_id(row.get('season_id', current_global_season_id), DEFAULT_LADDER_SEASON_ID),
            'fastest_pq_seconds': elapsed,
            'completed_at': row.get('completed_at'),
            'updated_at': row.get('updated_at') or row.get('completed_at'),
            'passed': bool(row.get('passed', False)),
        }
        existing = best_by_user.get(identity_key)
        if existing is None or (elapsed, -int(candidate.get('level', 1) or 1), str(candidate.get('completed_at') or ''), str(candidate.get('character_name') or '').lower()) < (float(existing.get('fastest_pq_seconds') or 0.0), -int(existing.get('level', 1) or 1), str(existing.get('completed_at') or ''), str(existing.get('character_name') or '').lower()):
            best_by_user[identity_key] = candidate
    rows_out = list(best_by_user.values())
    rows_out.sort(key=lambda row: (float(row.get('fastest_pq_seconds') or 0.0), -int(row.get('level', 1) or 1), str(row.get('character_name') or '').lower()))
...
def ladder_fastest_rows_for_class(rows: object, mode: object, target_class: object, current_global_season_id: object = DEFAULT_LADDER_SEASON_ID) -> List[Dict[str, object]]:
    ...
    best_by_user: Dict[str, Dict[str, object]] = {}
    for row in filtered_pq_ledger_rows(rows, mode, current_global_season_id):
        if normalize_player_class_name(row.get('player_class'), '') != class_name:
            continue
        elapsed = _coerce_fastest_pq_seconds(row.get('elapsed_seconds'))
        if elapsed is None:
            continue
...
def progression_rows_with_fastest_pq(rows: object, ledger_rows: object, mode: object, current_global_season_id: object = DEFAULT_LADDER_SEASON_ID) -> List[Dict[str, object]]:
    progression_rows = filtered_public_ladder_rows(rows, mode)
    best_by_user: Dict[str, float] = {}
    for ledger_row in filtered_pq_ledger_rows(ledger_rows, mode, current_global_season_id):
        elapsed = _coerce_fastest_pq_seconds(ledger_row.get('elapsed_seconds'))
        if elapsed is None:
            continue
        identity_key = _leaderboard_identity_key({
            'user_id': ledger_row.get('user_id'),
            'character_name': ledger_row.get('character_name'),
            'mode': ledger_row.get('mode'),
        })
        if not identity_key:
            continue
        existing = best_by_user.get(identity_key)
        if existing is None or elapsed < existing:
            best_by_user[identity_key] = elapsed
    enriched_rows: List[Dict[str, object]] = []
    for raw_row in progression_rows:
        row = dict(raw_row)
        identity_key = _leaderboard_identity_key(row)
        ledger_fastest = best_by_user.get(identity_key)
        current_fastest = _coerce_fastest_pq_seconds(row.get('fastest_pq_seconds'))
        if ledger_fastest is not None and (current_fastest is None or ledger_fastest < current_fastest):
            row['fastest_pq_seconds'] = ledger_fastest
        else:
            row['fastest_pq_seconds'] = current_fastest
...
def core_stat_help_text(stat_key: str) -> str:
    ...
    return descriptions.get(stat_key, 'Improves this core attribute and helps shape your build.')


def build_core_stat_tooltip_html(player: Optional['Player'], stat_key: str) -> str:
    label = html.escape(STAT_LABELS.get(stat_key, stat_key.upper()))
    help_text = html.escape(core_stat_help_text(stat_key))
    ...
    return (
        ...
        f"<div class='mq-prof-sub' style='margin-top:8px;color:#f5deb0;'>{html.escape(click_hint)}</div>"
        "</div>"
    )
...
class Player(Fighter):
    ...
    def from_dict(cls, data: Dict) -> 'Player':
        payload = dict(data)
        payload['player_class'] = normalize_player_class_name(payload.get('player_class'), str(payload.get('player_class') or 'Black Guard'))
...
def normalize_ladder_stats(data: Optional[Dict[str, Dict[str, Optional[float]]]]) -> Dict[str, Dict[str, Optional[float]]]:
    ...
    if isinstance(data, dict):
        for class_name, stats in data.items():
            normalized_class = normalize_player_class_name(class_name, '')
            if normalized_class not in normalized or not isinstance(stats, dict):
                continue
            normalized[normalized_class]['masterquest_attempts'] = max(
                int(normalized[normalized_class].get('masterquest_attempts', 0) or 0),
                int(stats.get('masterquest_attempts', 0) or 0),
            )
            normalized[normalized_class]['enemy_kills'] = max(
                int(normalized[normalized_class].get('enemy_kills', 0) or 0),
                int(stats.get('enemy_kills', 0) or 0),
            )
            normalized[normalized_class]['total_deaths'] = max(
                int(normalized[normalized_class].get('total_deaths', 0) or 0),
                int(stats.get('total_deaths', 0) or 0),
            )
            normalized[normalized_class]['wellspawns_killed'] = max(
                int(normalized[normalized_class].get('wellspawns_killed', 0) or 0),
                int(stats.get('wellspawns_killed', 0) or 0),
            )
            fastest = stats.get('fastest_masterquest_seconds')
            if fastest not in (None, ''):
                current_fastest = normalized[normalized_class].get('fastest_masterquest_seconds')
                fastest_value = float(fastest)
                if current_fastest in (None, '') or float(fastest_value) < float(current_fastest):
                    normalized[normalized_class]['fastest_masterquest_seconds'] = fastest_value
    return normalized
...
def build_glossary_text() -> str:
    ...
    lines.append('• Inn Vault stores up to 20 items. Storage costs 5 gold. Withdrawals are free. SSF disables the Bazaar entirely, while Core / SSF / HC keep separate ladders and fastest-PQ boards.')
    return '\n'.join(lines)
...
class SessionState:
    def __init__(self) -> None:
        ...
        self.ui_language: str = DEFAULT_UI_LANGUAGE
        self.accessibility_large_text: bool = False
        self.accessibility_high_contrast: bool = False
        self.accessibility_reduce_motion: bool = False
        ...
        self.masterquest_result_popup_open: bool = False
        self.masterquest_result_popup_text: str = ''
        self.masterquest_result_popup_tone: str = 'success'
        ...
        self._pending_cloud_sync_indexes: set[int] = set()
        self._pending_cloud_sync_all: bool = False
        self._pending_cloud_sync_force: bool = False
        self._cloud_sync_delay_seconds: float = 1.5
        self._last_cloud_sync_request_at: float = 0.0
        self._last_cloud_sync_flush_at: float = 0.0
        self._public_sync_min_interval_seconds: float = 6.0
        self._last_public_sync_at: float = 0.0
        self._public_sync_dirty: bool = False
        ...
        self.public_pq_ledger_status: str = ''
        self._last_public_pq_ledger_sync_hash: str = ''
        self.ladder_mode: str = 'Core'
        self.ladder_view: str = 'Players'
        self.ladder_ledger_page: int = 1
        self.ladder_player_view: str = 'Progression'
        self.ladder_progression_page: int = 1
        self.ladder_fastest_page: int = 1
        self.ladder_fastest_class_page: int = 1
        self.ladder_fastest_class_filter: str = 'Black Guard'
        ...
        self.restore_runtime_session()
    def _stored_ui_preferences(self) -> Dict[str, object]:
        try:
            stored = app.storage.user.get('ui_preferences', {})
        except Exception:
            stored = {}
        return stored if isinstance(stored, dict) else {}

    def persist_ui_preferences(self) -> None:
        try:
            app.storage.user['ui_preferences'] = {
                'language': normalize_ui_language(self.ui_language),
                'large_text': bool(self.accessibility_large_text),
                'high_contrast': bool(self.accessibility_high_contrast),
                'reduce_motion': bool(self.accessibility_reduce_motion),
                'saved_at': time.time(),
            }
        except Exception:
            pass
    ...
    def restore_ui_preferences(self) -> None:
        stored = self._stored_ui_preferences()
        self.ui_language = normalize_ui_language(stored.get('language', DEFAULT_UI_LANGUAGE))
        self.accessibility_large_text = bool(stored.get('large_text', False))
        self.accessibility_high_contrast = bool(stored.get('high_contrast', False))
        self.accessibility_reduce_motion = bool(stored.get('reduce_motion', False))

    def set_ui_language(self, value: object) -> None:
        self.ui_language = normalize_ui_language(value)
        self.persist_ui_preferences()

    def set_accessibility_large_text(self, value: object) -> None:
        self.accessibility_large_text = bool(value)
        self.persist_ui_preferences()

    def set_accessibility_high_contrast(self, value: object) -> None:
        self.accessibility_high_contrast = bool(value)
        self.persist_ui_preferences()

    def set_accessibility_reduce_motion(self, value: object) -> None:
        self.accessibility_reduce_motion = bool(value)
        self.persist_ui_preferences()
    ...
    def _stored_guest_slots(self) -> Dict[str, object]:
        try:
            stored = app.storage.user.get('guest_slots', {})
        except Exception:
            stored = {}
        return stored if isinstance(stored, dict) else {}

    def load_guest_slots_from_storage(self) -> List[Dict[str, object]]:
        stored = self._stored_guest_slots()
    ...
    def persist_guest_slots_storage(self) -> None:
        try:
            app.storage.user['guest_slots'] = {
    ...
    def clear_guest_slots_storage(self) -> None:
        try:
            app.storage.user.pop('guest_slots', None)
        except Exception:
            pass
    ...
    def enter_guest_mode(self) -> None:
        ...
        self.slots = self.load_guest_slots_from_storage()
        self._last_local_slots_hash = _stable_payload_hash(self.slots)
        self.set_auth_status('Guest chronicle opened. Progress stays on this browser until you claim an account. Public ladders and guild features still require sign-in.', 'info')
    ...
    def _refresh_auth_session(self, refresh_token: str = '') -> bool:
        if self.supabase is None:
            return False
        try:
            cleaned_refresh_token = str(refresh_token or '').strip()
            if cleaned_refresh_token:
                try:
                    self.supabase.auth.refresh_session(cleaned_refresh_token)
                except TypeError:
    ...
    def ensure_auth_session(self) -> bool:
        if self.supabase is None:
            self.auth_user_id = ''
        ...
        if self._refresh_auth_session(str(tokens.get('refresh_token') or '')):
            return True
        # Do not hard-clear a player's authenticated state on a single refresh miss.
        # Supabase and browser session refreshes can occasionally race or blip; keeping
    ...
    def _queue_cloud_sync(self, slot_indexes: Optional[List[int]] = None, force: bool = False) -> None:
        if self._cloud_sync_suspended or self.supabase is None or not self.is_authenticated():
            return
        if slot_indexes is None:
            self._pending_cloud_sync_all = True
        else:
            for raw_index in slot_indexes:
                ...
                if 1 <= index <= len(self.slots):
                    self._pending_cloud_sync_indexes.add(index)
        self._pending_cloud_sync_force = bool(self._pending_cloud_sync_force or force)
        now = time.monotonic()
        self._last_cloud_sync_request_at = now
        task = getattr(self, '_cloud_sync_task', None)
        if task is not None and not task.done():
            return
        try:
            loop = asyncio.get_running_loop()
        except RuntimeError:
            pending_indexes = None if self._pending_cloud_sync_all else sorted(self._pending_cloud_sync_indexes)
            pending_force = bool(self._pending_cloud_sync_force)
            delay = 0.0 if pending_force else float(getattr(self, '_cloud_sync_delay_seconds', 1.5) or 1.5)
            if delay > 0 and not pending_force and (now - float(getattr(self, '_last_cloud_sync_flush_at', 0.0) or 0.0)) < delay:
                return
            self._pending_cloud_sync_all = False
            self._pending_cloud_sync_indexes = set()
            self._pending_cloud_sync_force = False
            self.persist_to_cloud(slot_indexes=pending_indexes, force=pending_force)
            return
        self._cloud_sync_task = loop.create_task(self._run_queued_cloud_sync())

    async def _run_queued_cloud_sync(self) -> None:
        try:
            while True:
                delay = 0.0 if self._pending_cloud_sync_force else float(getattr(self, '_cloud_sync_delay_seconds', 0.75) or 0.75)
                if delay > 0:
                    await asyncio.sleep(delay)
                slot_indexes = None if self._pending_cloud_sync_all else sorted(self._pending_cloud_sync_indexes)
                force = bool(self._pending_cloud_sync_force)
                self._pending_cloud_sync_all = False
                self._pending_cloud_sync_indexes = set()
                self._pending_cloud_sync_force = False
                self.persist_to_cloud(slot_indexes=slot_indexes, force=force)
                if not self._pending_cloud_sync_all and not self._pending_cloud_sync_indexes and not self._pending_cloud_sync_force:
                    break
    ...
    def _stored_runtime_session(self) -> Dict[str, object]:
        ...
        try:
            active_slot_index = int(active_slot_index) if active_slot_index is not None else None
        except Exception:
            active_slot_index = None
        if active_slot_index is not None and not (0 <= active_slot_index < len(self.slots)):
            active_slot_index = None
        screen = str(stored.get('screen') or '').strip().lower()
        valid_screens = {'title', 'chronicle', 'class_select', 'town', 'game'}
        if screen not in valid_screens:
            screen = ''
        game_tab = str(stored.get('game_tab') or '').strip().lower()
        valid_tabs = {
            'arena', 'inventory', 'bazaar', 'marketplace', 'transmute', 'inn', 'well',
            'masterquest', 'guild_hall', 'ladder', 'profile', 'glossary', 'settings',
            'donate', 'stats',
        }
        if game_tab not in valid_tabs:
            game_tab = ''
        guest_mode = bool(stored.get('guest_mode', False))
        return {
    ...
    def persist_runtime_session(self) -> None:
        try:
            app.storage.user['runtime_session'] = {
                'active_slot_index': self.active_slot_index if self.active_slot_index is not None else None,
                'screen': str(self.screen or ''),
                'game_tab': str(self.game_tab or ''),
                'guest_mode': bool(self.guest_mode and not self.is_authenticated()),
                'saved_at': time.time(),
            }
        except Exception:
            pass
    ...
    def _stored_cloud_slot_backup(self) -> Dict[str, object]:
        try:
            stored = app.storage.user.get('cloud_slot_backup', {})
        except Exception:
            stored = {}
        return stored if isinstance(stored, dict) else {}

    def persist_cloud_slot_backup(self) -> None:
        if not SUPABASE_ENABLED:
            return
        user_id = str(getattr(self, 'auth_user_id', '') or '').strip()
        if not user_id:
            return
        try:
            app.storage.user['cloud_slot_backup'] = {
                'user_id': user_id,
                'slots': copy.deepcopy(self.slots),
                'saved_at': time.time(),
            }
    ...
    def restore_cloud_slot_backup(self) -> bool:
        if not SUPABASE_ENABLED:
            return False
        stored = self._stored_cloud_slot_backup()
        if str(stored.get('user_id') or '').strip() != str(getattr(self, 'auth_user_id', '') or '').strip():
            return False
        raw_slots = stored.get('slots')
        if not isinstance(raw_slots, list) or not raw_slots:
            return False
        restored_slots = [normalize_slot_payload(slot) for slot in raw_slots[:3]]
        while len(restored_slots) < 3:
            restored_slots.append(build_default_slot_payload())
    ...
    def restore_runtime_session(self) -> bool:
        stored = self._stored_runtime_session()
        self.guest_mode = bool(stored.get('guest_mode', False)) and not self.is_authenticated()
        if self.guest_mode:
            self.slots = self.load_guest_slots_from_storage()
            self._last_local_slots_hash = _stable_payload_hash(self.slots)
        active_slot_index = stored.get('active_slot_index')
        if active_slot_index is None:
            ...
            if self.guest_mode:
                ...
                self.screen = 'chronicle' if desired_screen == 'chronicle' else 'title'
                self.persist_runtime_session()
                return True
            return False
        try:
        ...
        if desired_screen == 'town':
            ...
            if safe_tab == 'inn':
                ...
                self.ensure_ladder_scene_state(False)
            elif safe_tab == 'marketplace':
                self.ensure_marketplace_offers(False)
            elif safe_tab == 'bazaar':
                self.refresh_bazaar_listings()
    ...
    def refresh_authenticated_user(self, persist_session: bool = True) -> bool:
        if self.supabase is None:
            self.auth_user_id = ''
            self.auth_user_email = ''
            return False
    ...
    def load_cloud_slots(self) -> bool:
        if self.supabase is None or not self.is_authenticated():
            return False
        if not self.ensure_auth_session():
            restored = self.restore_cloud_slot_backup()
            if restored:
                self.refresh_global_season_state()
                self.apply_pending_global_season_reset(False)
                ...
                return True
            self.set_auth_status('Your account session expired. Please sign in again.', 'warning')
            return False
        try:
            ...
            try:
                ...
                self._cloud_sync_suspended = False
            self.persist_cloud_slot_backup()
            self.refresh_global_season_state()
            ...
            if restored:
                self.refresh_global_season_state()
                self.apply_pending_global_season_reset(False)
                self.set_auth_status(f'Connected, but live cloud load failed. Restored cached chronicle while retrying: {exc}', 'warning')
                return True
    ...
    def _reset_cloud_sync_caches_if_needed(self) -> None:
        ...
        self._last_public_pq_ledger_sync_hash = ''
    ...
    def persist_to_cloud(self, slot_indexes: Optional[List[int]] = None, force: bool = False) -> None:
        ...
        try:
            ...
            if not payloads and not should_sync_public:
                return
            if not self.ensure_auth_session():
                self.set_auth_status('Cloud save sync is retrying because the account session needs to refresh.', 'warning')
                return
            self._last_cloud_sync_flush_at = time.monotonic()
            if payloads:
            ...
            if should_sync_public:
                self._public_sync_dirty = True
                now = time.monotonic()
                sync_interval = float(getattr(self, '_public_sync_min_interval_seconds', 6.0) or 6.0)
                if force or (now - float(getattr(self, '_last_public_sync_at', 0.0) or 0.0)) >= sync_interval:
    ...
    def sign_out(self) -> None:
        if self.supabase is not None and self.is_authenticated() and (self._pending_cloud_sync_all or self._pending_cloud_sync_indexes or self._pending_cloud_sync_force or self._public_sync_dirty):
            try:
                self.persist_to_cloud(slot_indexes=None if self._pending_cloud_sync_all else sorted(self._pending_cloud_sync_indexes), force=True)
            except Exception:
                pass
        task = getattr(self, '_cloud_sync_task', None)
        if task is not None and not task.done():
        ...
        self.auth_user_email = ''
        self.clear_auth_session_storage()
        self.clear_runtime_session_storage()
        self.player = None
        self.current_run_started_at = 0.0
        self.current_run_start_wall_time = 0.0
        self.current_monster = None
    ...
    def return_to_entry_scene(self) -> None:
        if SUPABASE_ENABLED and (self.is_authenticated() or self.guest_mode):
    ...
    def refresh_public_ladder(self) -> bool:
        ...
        if not self.ensure_auth_session():
            self.public_ladder_rows_cache = []
            self.public_ladder_status = "Your account session expired. Sign in again to read the registrar's global ledger."
            return False
        self.refresh_global_season_state()
        try:
    ...
    def persist_to_disk(self, force: bool = False) -> None:
        if self.guest_mode:
            ...
            if not force and slots_hash == self._last_local_slots_hash:
                return
            self.persist_guest_slots_storage()
            self._last_local_slots_hash = slots_hash
            return
        if SUPABASE_ENABLED:
            pending_indexes = [self.active_slot_index + 1] if self.active_slot_index is not None else None
            self._queue_cloud_sync(slot_indexes=pending_indexes, force=force)
            return
        slots_hash = _stable_payload_hash(self.slots)
        if not force and slots_hash == self._last_local_slots_hash:
            return
...
def ensure_masterquest_scene_state(self, new_visit: bool = False) -> None:
    ...
    if new_visit or not self.masterquest_attempt_active:
        ...
        self.masterquest_essence_order = masterquest_active_essence_keys(normalize_player_class_name(self.player.player_class, str(self.player.player_class or 'Black Guard')))
        self.masterquest_container_order = masterquest_active_vessel_keys(normalize_player_class_name(self.player.player_class, str(self.player.player_class or 'Black Guard')))
...
def masterquest_entry_blocker(self) -> str:
    if self.player is None:
        return 'There is no active chronicle to guide into Prismatic Quest.'
    ...
    if next_class is not None and next_class in self.unlocked_classes:
        return f'{next_class} is already unlocked.'
    ...
    if int(self.player.gold) < int(cost):
        return f'You need {cost} gold to attempt Prismatic Quest.'
    return ''

def begin_masterquest(self) -> None:
    blocker = self.masterquest_entry_blocker()
    if blocker:
        self.add_log(blocker, 'warning')
        self.set_auth_status(blocker, 'warning')
        return
    if self.player is None:
        return
    cost = masterquest_attempt_cost(normalize_player_class_name(self.player.player_class, str(self.player.player_class or 'Black Guard')))
    ...
    self.current_run_kills = 0
    self.open_game_tab('masterquest', f'You step into the prism chamber. {masterquest_slot_count(normalize_player_class_name(self.player.player_class, str(self.player.player_class or 'Black Guard')))} vessels wait for stolen light.')
...
def queue_masterquest_result_popup(self, passed: bool) -> None:
    self.masterquest_result_popup_text = 'You have succeeded the PQ!' if passed else 'You have failed the PQ!'
    self.masterquest_result_popup_tone = 'success' if passed else 'danger'
    self.masterquest_result_popup_open = True


def dismiss_masterquest_result_popup(self) -> None:
    self.masterquest_result_popup_open = False
    self.masterquest_result_popup_text = ''
    self.masterquest_result_popup_tone = 'success'
...
def arena_target_level(self) -> int:
    ...
    if self.arena_same_level:
        max_offset = max(0, int(self.player.level or 1) - 1)
        self.arena_level_offset = max(0, min(max_offset, int(getattr(self, 'arena_level_offset', 0) or 0)))
        self.arena_selected_level = max(1, int(self.player.level or 1) - self.arena_level_offset)
...
def log_status(self) -> None:
    ...
    if self.arena_same_level:
        arena_target_label = 'Hero Level' if int(getattr(self, 'arena_level_offset', 0) or 0) <= 0 else f'Hero Level - {int(getattr(self, "arena_level_offset", 0) or 0)}'
    else:
        arena_target_label = f'Lv {target_level}'
    self.add_log(
...
def ensure_ladder_scene_state(self, new_visit: bool = False) -> None:
    ...
    if new_visit or not self.public_ladder_rows_cache:
        self.refresh_public_ladder()
    if new_visit or not getattr(self, 'public_pq_ledger_rows_cache', []):
        self.refresh_public_pq_ledger()
...
def town_crier_status_html(self) -> str:
    source = str(getattr(self, 'town_coffers_source', 'local') or 'local')
    total_gold = int(getattr(self, 'town_coffers_total', 0) or 0)
    by_service = dict(getattr(self, 'town_coffers_by_service', {}) or {})
    if source == 'cloud_unavailable':
        body = 'The Town Crier slaps a sealed municipal ledger and grumbles that the shared town coffers cannot be read just now.'
    elif source == 'local':
        if total_gold <= 0:
        ...
        body = 'The Town Crier rattles an empty lockbox and swears the square is still waiting for its first proper rain of gold.'
    else:
        leading_service = ''
        leading_amount = 0
        if by_service:
        ...
        if total_gold < 250:
            ...
            opener = 'The Town Crier lifts both hands and declares that the square coffers have become a serious heap of coin.'
        else:
            opener = 'The Town Crier nearly sings it: the town coffers are groaning under a princely mountain of gold.'
        tail = (
            f" with the richest stream lately flowing from {html.escape(str(leading_label))}."
            if leading_amount > 0 else
            '.'
        )
        return (
            "<div class='mq-town-whisper'><strong>Town Crier</strong><br>"
...
def open_game_tab(self, tab_name: str, note: Optional[str] = None) -> None:
    ...
    if requested_tab == 'inn':
        ...
        self.refresh_global_season_state()
        if SUPABASE_ENABLED and self.is_authenticated():
            self.sync_public_leaderboard(force=True)
        self.refresh_public_ladder()
        self.refresh_public_pq_ledger()
        self.refresh_guild_leaderboard()
...
def record_masterquest_ledger_entry(self, passed: bool, elapsed_seconds: float) -> None:
    if self.player is None or self.active_slot_index is None or not (0 <= self.active_slot_index < len(self.slots)):
        return
    slot_index = int(self.active_slot_index) + 1
    slot = normalize_slot_payload(self.slots[self.active_slot_index])
    ledger_entries = normalize_pq_ledger_entries(slot.get('pq_ledger_entries', []))
    current_class = normalize_player_class_name(self.player.player_class, str(self.player.player_class or 'Black Guard'))
    current_name = clean_character_name(self.player.name)
    mode = slot_mode_from_slot_index(slot_index)
    season_id = int(self.current_global_season_id if slot_uses_global_ladder(mode) else sanitize_ladder_season_id(slot.get('season_id', DEFAULT_LADDER_SEASON_ID)))
    attempt_index = len(ledger_entries) + 1
    completed_at = _pq_ledger_iso_now()
    entry = normalize_pq_ledger_entry({
        'id': f"{self.auth_user_id or 'local'}:{mode}:{slot_index}:{int(time.time() * 1000)}:{random.randint(1000, 9999)}",
        'user_id': self.auth_user_id or '',
        'character_name': current_name,
        'player_class': current_class,
        'level': int(getattr(self.player, 'level', 1) or 1),
        'mode': mode,
        'season_id': season_id,
        'slot_index': slot_index,
        'attempt_index': attempt_index,
    ...
    slot['pq_ledger_entries'] = normalize_pq_ledger_entries(ledger_entries)
    self.slots[self.active_slot_index] = slot


def sync_public_pq_ledger(self, force: bool = False) -> None:
    if self.supabase is None or not self.is_authenticated():
        return
    if not self.ensure_auth_session():
        return
    ...
    for slot_index, raw_slot in enumerate(self.slots, start=1):
        ...
        mode = slot_mode_from_slot_index(slot_index)
        season_id = int(self.current_global_season_id if slot_uses_global_ladder(mode) else sanitize_ladder_season_id(slot.get('season_id', DEFAULT_LADDER_SEASON_ID)))
        for entry in normalize_pq_ledger_entries(slot.get('pq_ledger_entries', [])):
            payload = dict(entry)
            payload['user_id'] = str(self.auth_user_id or payload.get('user_id') or '')
            payload['slot_index'] = slot_index
            payload['mode'] = normalize_ladder_mode(payload.get('mode'), mode)
            payload['season_id'] = sanitize_ladder_season_id(payload.get('season_id', season_id), season_id)
            payload['player_class'] = normalize_player_class_name(payload.get('player_class'), str(payload.get('player_class') or 'Black Guard'))
            payload['character_name'] = clean_character_name(str(payload.get('character_name') or 'Nameless Hero'))
            payload['level'] = max(1, int(payload.get('level', 1) or 1))
            payload['passed'] = bool(payload.get('passed', False))
            payload['elapsed_seconds'] = _coerce_fastest_pq_seconds(payload.get('elapsed_seconds'))
            payload['completed_at'] = str(payload.get('completed_at') or _pq_ledger_iso_now())
            payload['updated_at'] = str(payload.get('updated_at') or payload['completed_at'])
            entries.append(payload)
    entries.sort(key=lambda row: str(row.get('id') or ''))
    payload_hash = _stable_payload_hash(entries) if entries else '__empty__'
    if not force and payload_hash == getattr(self, '_last_public_pq_ledger_sync_hash', ''):
        return
    try:
        if entries:
            self.supabase.table('pq_ledger_entries').upsert(entries, on_conflict='id').execute()
        self._last_public_pq_ledger_sync_hash = payload_hash
    except Exception as exc:
        self.public_pq_ledger_status = f'PQ ledger sync is waiting on database setup: {exc}'


def refresh_public_pq_ledger(self) -> bool:
    mode = normalize_ladder_mode(getattr(self, 'ladder_mode', self.current_slot_mode() if hasattr(self, 'current_slot_mode') else 'Core'))
    try:
        if not SUPABASE_ENABLED or self.supabase is None or not self.is_authenticated():
            rows = filtered_pq_ledger_rows(local_pq_ledger_rows_for_slots(self.slots, self.current_global_season_id), mode, self.current_global_season_id)
            self.public_pq_ledger_rows_cache = rows
            self.public_pq_ledger_status = f'Local PQ ledger holds {len(rows)} etched attempt(s) for {mode}.' if rows else f'No {mode} PQ attempts are etched locally yet.'
            return True
        self.refresh_global_season_state()
        fields = 'id, user_id, character_name, player_class, level, mode, season_id, slot_index, attempt_index, passed, elapsed_seconds, completed_at, updated_at'
        query = self.supabase.table('pq_ledger_entries').select(fields).eq('mode', mode)
        if slot_uses_global_ladder(mode):
            query = query.eq('season_id', int(self.current_global_season_id))
        response = query.order('completed_at', desc=True).limit(5000).execute()
        rows = filtered_pq_ledger_rows(_supabase_response_data(response), mode, self.current_global_season_id)
        self.public_pq_ledger_rows_cache = rows
        if rows:
            if slot_uses_global_ladder(mode):
                self.public_pq_ledger_status = f'{mode} Season {self.current_global_season_id} PQ ledger live with {len(rows)} etched attempt(s).'
            else:
                self.public_pq_ledger_status = f'{mode} PQ ledger live with {len(rows)} etched attempt(s).'
        else:
            if slot_uses_global_ladder(mode):
                self.public_pq_ledger_status = f'{mode} Season {self.current_global_season_id} has no etched PQ attempts yet.'
            else:
                self.public_pq_ledger_status = f'No {mode} PQ attempts are etched yet.'
        return True
    except Exception as exc:
        self.public_pq_ledger_rows_cache = []
        self.public_pq_ledger_status = f'PQ ledger unavailable until pq_ledger_entries is created: {exc}'
        return False
...
def sync_public_leaderboard(self, force: bool = False) -> None:
    ...
    if not self.ensure_auth_session():
        return
    self._reset_cloud_sync_caches_if_needed()
    self._last_public_sync_at = time.monotonic()
    try:
        self.refresh_global_season_state()
        self.sync_public_pq_ledger(force=force)
        ...
        for slot_index, raw_slot in enumerate(self.slots, start=1):
            ...
            try:
                select_fields = 'user_id, character_name, level, highest_class, class_rank, masterquest_attempts, ladder_resets, fastest_pq_seconds, season_id, slot_index, mode, updated_at'
                query = self.supabase.table('leaderboard_entries').select(select_fields).eq('user_id', self.auth_user_id).eq('mode', mode)
                if slot_uses_global_ladder(mode):
                    query = query.eq('season_id', season_id)
                existing_rows = _supabase_response_data(query.execute()) or []
            except Exception:
                existing_rows = []
            payload = _merge_leaderboard_fastest_time(payload, existing_rows)
            leaderboard_hash = _stable_payload_hash(payload)
            if force or self._last_public_leaderboard_hashes.get(mode) != leaderboard_hash:
                try:
                    delete_query = self.supabase.table('leaderboard_entries').delete().eq('user_id', self.auth_user_id).eq('mode', mode)
                    if slot_uses_global_ladder(mode):
                        delete_query = delete_query.eq('season_id', season_id)
                    delete_query.execute()
                except Exception:
                    pass
                wrote_payload = False
                for fallback_payload in (
                    payload,
                    {k: payload[k] for k in ('user_id', 'character_name', 'level', 'highest_class', 'class_rank', 'slot_index', 'masterquest_attempts', 'ladder_resets', 'season_id', 'mode')},
                    {k: payload[k] for k in ('user_id', 'character_name', 'level', 'highest_class', 'class_rank', 'slot_index', 'mode')},
                ):
                    try:
...
def refresh_guild_hall_state(self) -> bool:
    ...
    try:
        ...
        if isinstance(membership, dict) and membership.get('guild_id'):
                ...
                if isinstance(profile_rows, list):
                    for row in profile_rows:
                        if isinstance(row, dict):
                            ...
                            profile_points[member_user_id] = profile_points.get(member_user_id, 0) + max(0, int(row.get('pq_points', 0) or 0))
                self.guild_member_rows = []
            ...
            membership_role = str(membership.get('role') or '').lower()
            if membership_role in {'leader', 'officer'}:
...
def invite_to_guild_target(self, target_user_id: str = '', target_name: str = '') -> bool:
    ...
    membership_role = str(guild_membership_row.get('role') or '').lower()
    if not guild_membership_row or membership_role not in {'leader', 'officer'} or not guild_row:
        self.set_guild_status('Only a Guild Leader or Officer can send invitations.', 'warning')
        return False
...
def revoke_guild_invite(self, invite_id: str) -> bool:
    if not self._guild_cloud_enabled():
        self.set_guild_status('Guild invites need Supabase and an authenticated account.', 'warning')
        return False
    invite_id = str(invite_id or '').strip()
    if not invite_id:
        self.set_guild_status('That invitation is no longer available.', 'warning')
        return False
    membership_role = str(getattr(self, 'guild_membership_row', {}).get('role') or '').lower()
    guild_id = str(getattr(self, 'guild_row', {}).get('id') or '').strip() if isinstance(getattr(self, 'guild_row', {}), dict) else ''
    if membership_role not in {'leader', 'officer'} or not guild_id:
        self.set_guild_status('Only guild leadership can revoke pending invites.', 'warning')
        return False
    try:
        invite_rows = _supabase_response_data(self.supabase.table('guild_invites').select('id, guild_id, status').eq('id', invite_id).limit(1).execute())
        invite_row = invite_rows[0] if isinstance(invite_rows, list) and invite_rows else (invite_rows if isinstance(invite_rows, dict) else {})
        if not isinstance(invite_row, dict) or str(invite_row.get('guild_id') or '') != guild_id:
            self.set_guild_status('That invitation does not belong to your guild.', 'warning')
            return False
        if str(invite_row.get('status') or '').lower() != 'pending':
            self.set_guild_status('That invitation has already been resolved.', 'warning')
            return False
        self.supabase.table('guild_invites').update({'status': 'revoked'}).eq('id', invite_id).execute()
        self.refresh_guild_hall_state()
        self.set_guild_status('Pending invitation revoked.', 'success')
        return True
    except Exception as exc:
        self.set_guild_status(f'Could not revoke invite: {exc}', 'danger')
        return False

def update_guild_member_role(self, target_user_id: str, new_role: str) -> bool:
    if not self._guild_cloud_enabled():
        self.set_guild_status('Guild role changes need Supabase and an authenticated account.', 'warning')
        return False
    guild_row = getattr(self, 'guild_row', {}) if isinstance(getattr(self, 'guild_row', {}), dict) else {}
    guild_membership_row = getattr(self, 'guild_membership_row', {}) if isinstance(getattr(self, 'guild_membership_row', {}), dict) else {}
    if str(guild_membership_row.get('role') or '').lower() != 'leader' or not guild_row:
        self.set_guild_status('Only the Guild Leader can change roster roles.', 'warning')
        return False
    guild_id = str(guild_row.get('id') or '').strip()
    cleaned_target_user_id = str(target_user_id or '').strip()
    desired_role = str(new_role or '').strip().lower()
    if desired_role not in {'member', 'officer'}:
        self.set_guild_status('That role cannot be assigned here.', 'warning')
        return False
    if not guild_id or not cleaned_target_user_id:
        self.set_guild_status('That member is no longer available.', 'warning')
        return False
    if cleaned_target_user_id == str(self.auth_user_id or ''):
        self.set_guild_status('Use dissolve controls rather than changing your own leader role.', 'warning')
        return False
    try:
        member_rows = _supabase_response_data(self.supabase.table('guild_memberships').select('guild_id, user_id, role, member_name').eq('guild_id', guild_id).eq('user_id', cleaned_target_user_id).limit(1).execute())
        member_row = member_rows[0] if isinstance(member_rows, list) and member_rows else (member_rows if isinstance(member_rows, dict) else {})
        if not isinstance(member_row, dict) or str(member_row.get('guild_id') or '') != guild_id:
            self.set_guild_status('That member no longer appears on your roster.', 'warning')
            return False
        current_role = str(member_row.get('role') or 'member').lower()
        if current_role == 'leader':
            self.set_guild_status('The Guild Leader cannot be changed here.', 'warning')
            return False
        if current_role == desired_role:
            self.set_guild_status('That roster role is already set.', 'info')
            return False
        self.supabase.table('guild_memberships').update({'role': desired_role}).eq('guild_id', guild_id).eq('user_id', cleaned_target_user_id).execute()
        self.refresh_guild_hall_state()
        member_name = clean_character_name(str(member_row.get('member_name') or 'That member'))
        self.set_guild_status(f'{member_name} is now a {desired_role.title()}.', 'success')
        return True
    except Exception as exc:
        self.set_guild_status(f'Could not update roster role: {exc}', 'danger')
        return False

def remove_guild_member(self, target_user_id: str) -> bool:
    if not self._guild_cloud_enabled():
        self.set_guild_status('Guild roster updates need Supabase and an authenticated account.', 'warning')
        return False
    guild_row = getattr(self, 'guild_row', {}) if isinstance(getattr(self, 'guild_row', {}), dict) else {}
    guild_membership_row = getattr(self, 'guild_membership_row', {}) if isinstance(getattr(self, 'guild_membership_row', {}), dict) else {}
    if str(guild_membership_row.get('role') or '').lower() != 'leader' or not guild_row:
        self.set_guild_status('Only the Guild Leader can remove members.', 'warning')
        return False
    guild_id = str(guild_row.get('id') or '').strip()
    cleaned_target_user_id = str(target_user_id or '').strip()
    if not guild_id or not cleaned_target_user_id:
        ...
        return False
    if cleaned_target_user_id == str(self.auth_user_id or ''):
        self.set_guild_status('Use Dissolve Guild if you want to close the hall yourself.', 'warning')
        return False
    try:
        member_rows = _supabase_response_data(self.supabase.table('guild_memberships').select('guild_id, user_id, role, member_name').eq('guild_id', guild_id).eq('user_id', cleaned_target_user_id).limit(1).execute())
        member_row = member_rows[0] if isinstance(member_rows, list) and member_rows else (member_rows if isinstance(member_rows, dict) else {})
        if not isinstance(member_row, dict) or str(member_row.get('guild_id') or '') != guild_id:
            self.set_guild_status('That member no longer appears on your roster.', 'warning')
            return False
        if str(member_row.get('role') or '').lower() == 'leader':
            self.set_guild_status('The Guild Leader cannot be removed from the roster this way.', 'warning')
            return False
        self.supabase.table('guild_memberships').delete().eq('guild_id', guild_id).eq('user_id', cleaned_target_user_id).execute()
        try:
            self.supabase.table('guild_invites').update({'status': 'revoked'}).eq('guild_id', guild_id).eq('invitee_user_id', cleaned_target_user_id).eq('status', 'pending').execute()
        except Exception:
            pass
        self.refresh_guild_hall_state()
        self.refresh_guild_leaderboard()
        member_name = clean_character_name(str(member_row.get('member_name') or 'That member'))
        self.set_guild_status(f'{member_name} has been removed from the guild.', 'success')
        return True
    except Exception as exc:
        self.set_guild_status(f'Could not remove guild member: {exc}', 'danger')
        return False

def leave_guild(self) -> bool:
    if not self._guild_cloud_enabled():
        self.set_guild_status('Leaving a guild needs Supabase and an authenticated account.', 'warning')
        return False
    guild_membership_row = getattr(self, 'guild_membership_row', {}) if isinstance(getattr(self, 'guild_membership_row', {}), dict) else {}
    guild_row = getattr(self, 'guild_row', {}) if isinstance(getattr(self, 'guild_row', {}), dict) else {}
    membership_role = str(guild_membership_row.get('role') or '').lower()
    guild_id = str(guild_row.get('id') or '').strip()
    if not guild_id or not guild_membership_row:
        self.set_guild_status('No guild bind currently holds your name.', 'warning')
        return False
    if membership_role == 'leader':
        self.set_guild_status('The Guild Leader must dissolve the guild rather than leave it.', 'warning')
        return False
    try:
        self.supabase.table('guild_memberships').delete().eq('guild_id', guild_id).eq('user_id', self.auth_user_id).execute()
        try:
            self.supabase.table('guild_invites').update({'status': 'declined'}).eq('invitee_user_id', self.auth_user_id).eq('status', 'pending').execute()
        except Exception:
            pass
        self.refresh_guild_hall_state()
        self.refresh_guild_leaderboard()
        self.set_guild_status('You leave the guild and let the hall door close behind you.', 'info')
        return True
    except Exception as exc:
        self.set_guild_status(f'Could not leave guild: {exc}', 'danger')
        return False

def dissolve_guild(self) -> bool:
    if not self._guild_cloud_enabled():
        self.set_guild_status('Dissolving a guild needs Supabase and an authenticated account.', 'warning')
        return False
    guild_row = getattr(self, 'guild_row', {}) if isinstance(getattr(self, 'guild_row', {}), dict) else {}
    guild_membership_row = getattr(self, 'guild_membership_row', {}) if isinstance(getattr(self, 'guild_membership_row', {}), dict) else {}
    if str(guild_membership_row.get('role') or '').lower() != 'leader' or not guild_row:
        self.set_guild_status('Only the Guild Leader can dissolve the guild.', 'warning')
        return False
    guild_id = str(guild_row.get('id') or '').strip()
    guild_name = str(guild_row.get('name') or 'Your guild').strip() or 'Your guild'
    if not guild_id:
        self.set_guild_status('That guild is no longer available.', 'warning')
        return False
    try:
        # Clear dependent rows first in case cascading deletes are not configured.
        for table_name in ('guild_chat_messages', 'guild_invites', 'guild_memberships'):
            try:
                self.supabase.table(table_name).delete().eq('guild_id', guild_id).execute()
            except Exception:
                pass
        self.supabase.table('guilds').delete().eq('id', guild_id).execute()
        self.refresh_guild_hall_state()
        self.refresh_guild_leaderboard()
        self.set_guild_status(f'{guild_name} has been dissolved. The hall stands empty again.', 'info')
        return True
    except Exception as exc:
        self.set_guild_status(f'Could not dissolve guild: {exc}', 'danger')
        return False
    ...
    try:
        ...
        if isinstance(profile_rows, list):
            for row in profile_rows:
                if isinstance(row, dict):
                    member_user_id = str(row.get('user_id') or '').strip()
                    pq_by_user[member_user_id] = pq_by_user.get(member_user_id, 0) + max(0, int(row.get('pq_points', 0) or 0))
...
SessionState._bazaar_cloud_write_failure = _bazaar_cloud_write_failure
...
SessionState.masterquest_entry_blocker = masterquest_entry_blocker
...
SessionState.queue_masterquest_result_popup = queue_masterquest_result_popup
SessionState.dismiss_masterquest_result_popup = dismiss_masterquest_result_popup
...
SessionState.record_masterquest_ledger_entry = record_masterquest_ledger_entry
SessionState.sync_public_pq_ledger = sync_public_pq_ledger
SessionState.refresh_public_pq_ledger = refresh_public_pq_ledger
...
SessionState.import_save = import_save
SessionState._town_coffers_cloud_enabled = _town_coffers_cloud_enabled
SessionState.town_crier_status_html = town_crier_status_html
...
SessionState.revoke_guild_invite = revoke_guild_invite
SessionState.update_guild_member_role = update_guild_member_role
SessionState.remove_guild_member = remove_guild_member
SessionState.leave_guild = leave_guild
SessionState.dissolve_guild = dissolve_guild
...
def main_page(request: Request) -> None:
    ...
    masterquest_result_dialog = ui.dialog()

    with masterquest_result_dialog:
        with ui.card().classes('mq-card max-w-[560px] w-[92vw] p-6 md:p-7'):
            masterquest_result_title = ui.label('Prismatic Quest').classes('text-3xl font-semibold text-slate-100')
            masterquest_result_body = ui.label('').classes('text-slate-200 text-xl leading-8 mt-4')
            with ui.row().classes('justify-end gap-3 mt-7 max-[640px]:w-full max-[640px]:flex-wrap'):
                ui.button('Continue', on_click=lambda: (state.dismiss_masterquest_result_popup(), masterquest_result_dialog.close(), request_render_refresh())).classes('mq-btn-gold rounded-xl px-6 py-3 font-semibold text-lg max-[640px]:w-full')

    def sync_masterquest_result_dialog(force: bool = False) -> None:
        popup_open = bool(getattr(state, 'masterquest_result_popup_open', False))
        popup_text = str(getattr(state, 'masterquest_result_popup_text', '') or '')
        popup_tone = str(getattr(state, 'masterquest_result_popup_tone', 'success') or 'success')
        if popup_text:
            masterquest_result_body.text = popup_text
        title_remove = 'text-emerald-300 text-rose-300 text-amber-200'
        if popup_tone == 'danger':
            masterquest_result_title.classes(remove=title_remove).classes(add='text-rose-300')
        elif popup_tone == 'warning':
            masterquest_result_title.classes(remove=title_remove).classes(add='text-amber-200')
        else:
            masterquest_result_title.classes(remove=title_remove).classes(add='text-emerald-300')
        if popup_open and popup_text:
            masterquest_result_dialog.open()
        else:
            masterquest_result_dialog.close()
    ...
    def open_marketplace_buy_dialog(index: int) -> None:
        pending_index = int(index)
        state.marketplace_pending_purchase_index = pending_index
        offer = state.marketplace_offers[pending_index] if 0 <= pending_index < len(state.marketplace_offers) else None
        try:
            marketplace_purchase_dialog.close()
        except Exception:
            pass
        if offer is None or state.player is None:
            return
        ...
        detail_lines = [
            offer.item.summary(),
            offer.item.short_stat_text(),
            f'Required level: {required_level}. ' + ('You can equip it now.' if can_equip_now else 'You can still buy it now and bank it in inventory for later.'),
            f'Price: {offer.price} gold',
        ]
        def confirm_purchase() -> None:
            try:
                state.buy_marketplace_offer(state.marketplace_pending_purchase_index)
            finally:
                state.marketplace_pending_purchase_index = -1
                try:
                    marketplace_purchase_dialog.close()
                except Exception:
                    pass
        ...
        open_inventory_confirmation(
            'Buy This Offer?',
            'The marketkeepers slide the relic forward and wait for your nod.',
            '\n'.join(line for line in detail_lines if str(line or '').strip()),
            'Confirm Purchase',
            'mq-btn-gold',
            confirm_purchase,
        )
    ...
    def render() -> None:
        ...
        sync_masterquest_result_dialog()
        screen_class = state.screen.replace('_', '-')
        scene_class = active_scene.replace('_', '-')
        language_code = normalize_ui_language(getattr(state, 'ui_language', DEFAULT_UI_LANGUAGE))
        page_classes = [
            'mq-page',
            f'mq-screen-{screen_class}',
            f'mq-scene-{scene_class}',
            f'mq-lang-{language_code}',
            'w-full', 'items-center', 'px-4', 'py-5', 'md:px-6', 'lg:px-8',
        ]
        if getattr(state, 'accessibility_large_text', False):
            page_classes.append('mq-a11y-large-text')
        if getattr(state, 'accessibility_high_contrast', False):
            page_classes.append('mq-a11y-high-contrast')
        if getattr(state, 'accessibility_reduce_motion', False):
            page_classes.append('mq-a11y-reduce-motion')
        with ui.column().classes(' '.join(page_classes)):
            if state.screen == 'title':
                title_lang = normalize_ui_language(getattr(state, 'ui_language', DEFAULT_UI_LANGUAGE))
                t = lambda key, **kwargs: localized_title_text(title_lang, key, **kwargs)
                        ...
                        with ui.element('div').classes('mq-title-stage w-full'):
                            ...
                            if title_art_url:
                                with ui.element('div').classes('mq-title-image-wrap'):
                                    ui.html(
                                        f"<div class='mq-title-image-fit' style='--mq-title-art-w:{max(title_art_width, 1)}; --mq-title-art-h:{max(title_art_height, 1)};'><img src='{html.escape(title_art_url, quote=True)}' alt='{html.escape(t('title_art_alt'), quote=True)}' class='mq-title-image-static' loading='eager' decoding='async' draggable='false'></div>"
                                    )
                            else:
                                with ui.column().classes('absolute inset-0 items-center justify-center gap-4'):
                                    ui.label(t('fallback_title')).classes('text-5xl font-bold text-slate-100 tracking-[0.18em]')
                                    ui.label(t('restore_title_art_hint')).classes('text-slate-400')
                            ui.label(t('title_caption')).classes('mq-title-caption')
                    with ui.column().classes('mq-title-side-stack w-full gap-4'):
                        with ui.card().classes('mq-side-card mq-title-side-card-rich p-5'):
                            ui.label(t('account_cloud_saves')).classes('text-2xl font-semibold text-slate-100')
                            if SUPABASE_ENABLED:
                                if state.is_authenticated():
                                    ui.label(t('signed_in_as', email=state.auth_user_email or state.auth_email)).classes('text-slate-200 mt-2 leading-6')
                                    ui.label(t('signed_in_ledger_hint')).classes('text-slate-300 mt-1 leading-6')
                                    if state.auth_status:
                                        ui.html(f"<div class='mq-state-banner {state.auth_status_tone}'>{html.escape(state.auth_status)}</div>")
                                    ui.button(t('open_chronicle_slots'), on_click=lambda: (state.go_to_chronicles(), request_render_refresh())).classes('w-full font-semibold tracking-wide rounded-xl py-3 mt-4 mq-btn-gold')
                                    ui.button(t('sign_out'), on_click=lambda: (state.sign_out(), request_render_refresh())).classes('w-full font-semibold tracking-wide rounded-xl py-3 mt-3 mq-btn-secondary')
                                else:
                                    ui.label(t('create_signin_hint')).classes('text-slate-300 mt-2 leading-6')
                                    email_input = ui.input(t('email'), value=state.auth_email).classes('w-full mt-4')
                                    email_input.props('outlined dense clearable input-style=color: var(--mq-text-main); aria-label=Email')
                                    email_input.on_value_change(lambda e: setattr(state, 'auth_email', str(e.value or '').strip()))
                                    password_input = ui.input(t('password'), value=state.auth_password, password=True, password_toggle_button=True).classes('w-full mt-3')
                                    password_input.props('outlined dense clearable input-style=color: var(--mq-text-main); aria-label=Password')
                                    password_input.on_value_change(lambda e: setattr(state, 'auth_password', str(e.value or '')))
                                    ui.label(t('email_confirmation_note')).classes('text-slate-500 text-xs mt-2 leading-5')
                                    if state.auth_status:
                                        ui.html(f"<div class='mq-state-banner {state.auth_status_tone}'>{html.escape(state.auth_status)}</div>")
                                    with ui.row().classes('w-full gap-3 mt-4 max-[640px]:flex-wrap'):
                                        ui.button(t('create_account'), on_click=lambda: (state.sign_up(), request_render_refresh())).classes('flex-1 font-semibold tracking-wide rounded-xl py-3 mq-btn-secondary max-[640px]:w-full')
                                        ui.button(t('sign_in'), on_click=lambda: (state.sign_in(), request_render_refresh())).classes('flex-1 font-semibold tracking-wide rounded-xl py-3 mq-btn-gold max-[640px]:w-full')
                                    ui.label(t('discord_login_hint')).classes('text-slate-400 text-sm mt-3 leading-5')
                                    ...
                                    ui.button(t('sign_in_with_discord'), on_click=_start_discord_oauth).classes('w-full font-semibold tracking-wide rounded-xl py-3 mt-3 mq-btn-secondary')
                                    ui.label('Want to try the climb first? Guest records stay on this browser until you claim an account.').classes('text-slate-400 text-sm mt-3 leading-5')
                                    ui.button('Open Guest Chronicle' if state.guest_mode else 'Play as Guest', on_click=lambda: (state.enter_guest_mode(), request_render_refresh())).classes('w-full font-semibold tracking-wide rounded-xl py-3 mt-3 mq-btn-gold')
                            else:
                                ui.label(t('local_slots_only')).classes('text-slate-300 mt-2 leading-6')
                                ui.button(t('open_chronicle_slots'), on_click=lambda: (state.go_to_chronicles(), request_render_refresh())).classes('w-full font-semibold tracking-wide rounded-xl py-3 mt-4 mq-btn-gold')
                                if state.auth_status:
                                    ui.html(f"<div class='mq-state-banner {state.auth_status_tone}'>{html.escape(state.auth_status)}</div>")
                        with ui.card().classes('mq-side-card mq-title-side-card-rich p-4'):
                            ui.label(t('community_server')).classes('mq-panel-caption')
                            ui.label(t('community_description')).classes('text-slate-300 leading-6 mt-2')
                            with ui.link(target=COMMUNITY_DISCORD_URL, new_tab=True):
                                ui.button(t('open_community_discord'), icon='forum').classes('w-full font-semibold tracking-wide rounded-xl py-3 mt-4 mq-btn-gold')
                return
            if state.screen == 'chronicle':
                chronicle_lang = normalize_ui_language(getattr(state, 'ui_language', DEFAULT_UI_LANGUAGE))
                t = lambda key, **kwargs: localized_title_text(chronicle_lang, key, **kwargs)
                with ui.row().classes('mq-shell w-full items-stretch gap-6 no-wrap max-[1200px]:flex-wrap'):
                    title_art_url, title_art_width, title_art_height = get_title_screen_asset_meta()
                    with ui.card().classes('mq-title-card w-full flex-1 p-4 lg:p-5'):
                        with ui.element('div').classes('mq-title-stage w-full'):
                            ...
                            if title_art_url:
                                ...
                                with ui.column().classes('absolute inset-0 items-center justify-center gap-4'):
                                    ui.label(t('fallback_title')).classes('text-5xl font-bold text-slate-100 tracking-[0.18em]')
                                    ui.label(t('restore_title_art_hint')).classes('text-slate-400')
                            ui.label(t('chronicle_caption')).classes('mq-title-caption')
                    with ui.column().classes('mq-title-side-stack w-full gap-4'):
                        with ui.card().classes('mq-side-card mq-title-side-card-rich p-5'):
                            ...
                            with ui.column().classes('w-full flex-[3] gap-4'):
                                ...
                                with ui.row().classes('w-full items-center justify-between gap-3 max-[800px]:flex-wrap'):
                                    with ui.row().classes('gap-2 max-[800px]:w-full'):
                                        back = ui.button('Back to Chronicle Slots' if (SUPABASE_ENABLED and (state.is_authenticated() or state.guest_mode)) else 'Back to Title', on_click=lambda: (state.return_to_entry_scene(), request_render_refresh()))
                    ...
                    with ui.card().classes('mq-town-header w-full p-3 md:p-4'):
                        with ui.row().classes('w-full items-start justify-between gap-3 max-[900px]:flex-wrap'):
                            with ui.column().classes('gap-1 max-w-[860px]'):
                                ...
                                ui.html(state.town_crier_status_html())
                            ...
                            with ui.element('div').classes('mq-town-route-groups w-full mt-4'):
                                with ui.element('div').classes('mq-town-route-group gameplay'):
                                    ...
                                    with ui.element('div').classes('mq-route-grid w-full mt-4'):
                                        ...
                                        if masterquest_blocker:
                                            masterquest_town_btn.classes('opacity-70')
                                            masterquest_town_btn.disable()
                                            masterquest_town_btn.props(f'title={json.dumps(masterquest_blocker)}')
            ...
            with ui.column().classes('mq-arena-shell w-full gap-4'):
                ...
                if state.game_tab != 'arena':
                    ...
                    if state.game_tab == 'inventory':
                        ...
                        membership_row = getattr(state, 'guild_membership_row', {}) if isinstance(getattr(state, 'guild_membership_row', {}), dict) else {}
                        membership_role = str(membership_row.get('role') or '').lower()
                        is_leader = membership_role == 'leader'
                        is_officer = membership_role == 'officer'
                        can_manage_invites = membership_role in {'leader', 'officer'}
                        visible_guild_messages = getattr(state, 'guild_message_rows', [])[-80:] if isinstance(getattr(state, 'guild_message_rows', []), list) else []
                        with ui.column().classes('w-full gap-4'):
                            with ui.card().classes('mq-card w-full p-5'):
                                ui.label('Guild Hall').classes('text-2xl font-semibold text-slate-100')
                                ui.label("Forge a guild for 1000 gold, keep a live member roster, hold a private guild channel, and shape a hall that actually feels inhabited.").classes('text-slate-300 leading-7 mt-2')
                                with ui.card().classes('mq-panel-frame p-4 mt-4'):
                                    ui.label('STATUS').classes('mq-panel-caption')
                            ...
                            if not state.is_authenticated():
                                ...
                                guild_name = str(guild_row.get('name') or 'Unnamed Guild')
                                with ui.row().classes('w-full gap-4 items-start max-[1180px]:flex-wrap'):
                                    with ui.card().classes('mq-card flex-[0.9] min-w-[300px] p-4'):
                                        ui.label(guild_name).classes('text-xl font-semibold text-slate-100')
                                        ui.label(f"Role: {membership_role.title()}").classes('mq-detail-text mt-2')
                                        ui.label(f"Members {len(member_rows)}/{state.current_guild_member_limit()}").classes('mq-detail-text mt-2')
                                        total_pq = sum(int(member.get('pq_points', 0) or 0) for member in member_rows)
                                        ui.label(f'Guild PQ Pool: {total_pq}').classes('mq-detail-text mt-2')
                                        with ui.row().classes('gap-2 mt-4 flex-wrap'):
                                            ...
                                            if is_leader:
                                                ui.button('Dissolve Guild', on_click=lambda: (state.dissolve_guild(), request_render_refresh())).classes('mq-btn-secondary rounded-xl px-5 py-3 font-semibold')
                                            else:
                                                ui.button('Leave Guild', on_click=lambda: (state.leave_guild(), request_render_refresh())).classes('mq-btn-secondary rounded-xl px-5 py-3 font-semibold')
                                    with ui.card().classes('mq-card flex-[1.15] min-w-[360px] p-4'):
                                        ui.label('Roster').classes('mq-inv-section-title mb-3')
                                        if member_rows:
                                            for member in member_rows:
                                                member_user_id = str(member.get('user_id') or '')
                                                member_name = str(member.get('member_name') or 'Unknown Adventurer')
                                                member_role = str(member.get('role') or 'member').lower()
                                                joined_at = str(member.get('joined_at') or '')
                                                joined_label = joined_at.split('T')[0] if joined_at else 'Unknown'
                                                with ui.card().classes('mq-panel-frame p-3 mb-3'):
                                                    with ui.row().classes('w-full items-start justify-between gap-3 flex-wrap'):
                                                        with ui.column().classes('gap-1 min-w-0 flex-1'):
                                                            with ui.row().classes('items-center gap-2 flex-wrap'):
                                                                ui.label(member_name).classes('text-slate-100 font-semibold')
                                                        ...
                                                        if is_leader and member_user_id and member_user_id != str(state.auth_user_id or ''):
                                                            with ui.row().classes('items-center gap-2 flex-wrap justify-end'):
                                                                if member_role == 'member':
                                                                    ui.button('Promote Officer', on_click=lambda uid=member_user_id: (state.update_guild_member_role(uid, 'officer'), request_render_refresh())).classes('mq-btn-secondary rounded-lg px-3 py-2 font-semibold')
                                                                elif member_role == 'officer':
                                                                    ui.button('Demote Member', on_click=lambda uid=member_user_id: (state.update_guild_member_role(uid, 'member'), request_render_refresh())).classes('mq-btn-secondary rounded-lg px-3 py-2 font-semibold')
                                                                if member_role != 'leader':
                                                                    ui.button('Remove', on_click=lambda uid=member_user_id: (state.remove_guild_member(uid), request_render_refresh())).classes('mq-btn-secondary rounded-lg px-3 py-2 font-semibold')
                                        else:
                                            ui.label('No members have been etched into this roster yet.').classes('mq-detail-text')
                                with ui.row().classes('w-full gap-4 items-start max-[1180px]:flex-wrap'):
                                    with ui.card().classes('mq-card flex-[1.1] min-w-[360px] p-4'):
                                        ui.label('Guild Lounge').classes('mq-inv-section-title mb-3')
                                        with ui.scroll_area().classes('w-full max-h-[430px] pr-3'):
                                                                ...
                                                                with ui.element('div').classes('min-w-0 flex-1'):
                                                                    with ui.element('div').classes('mq-town-chat-author-row flex-wrap gap-2'):
                                                                        ...
                                                                        if stamp:
                                                                            ui.label(stamp).classes('mq-town-chat-stamp')
                                                                with ui.element('div').classes('mq-town-chat-utility'):
                                                                    ui.button(icon='visibility', on_click=lambda uid=author_user_id, name=author_name: open_public_profile_dialog(uid, name, 'guild_hall')).props('flat round dense size=xs').classes('mq-town-chat-eye')
                                                            ui.html(f"<div class='mq-town-chat-body'>{body}</div>")
                                                else:
                                        ...
                                        def _submit_guild_hall_chat() -> None:
                                            if state.submit_town_chat_entry(guild_input.value, 'guild'):
                                                state.guild_message_draft = ''
                                                request_render_refresh()
                                        guild_input.on('keydown.enter', lambda _e: _submit_guild_hall_chat())
                                        with ui.row().classes('w-full items-end justify-between gap-3 mt-3 max-[820px]:flex-wrap'):
                                            ui.label('Guild posts are visible only to your current roster.').classes('mq-town-chat-footnote')
                                            ui.button('Send to Guild', icon='send', on_click=_submit_guild_hall_chat).classes('mq-btn-gold mq-town-chat-send font-semibold')
                                        if getattr(state, 'guild_message_status', ''):
                                            ui.label(str(state.guild_message_status)).classes('mq-town-chat-footnote mt-2')
                                        ...
                                        if invite_rows:
                                            with ui.card().classes('mq-card w-full p-4'):
                                                ...
                                                for invite in invite_rows:
                                                    ...
                                                    invitee_name = str(invite.get('invitee_name') or 'Unknown Adventurer')
                        ...
                        progression_rows_all = progression_rows_with_fastest_pq(getattr(state, 'public_ladder_rows_cache', []), getattr(state, 'public_pq_ledger_rows_cache', []), current_ladder_mode, state.current_global_season_id)
                        ...
                        ledger_rows_all = filtered_pq_ledger_rows(getattr(state, 'public_pq_ledger_rows_cache', []), current_ladder_mode, state.current_global_season_id)
                        ledger_rows_page, ledger_page, ledger_total_pages, ledger_page_options = paginate_leaderboard_rows(ledger_rows_all, getattr(state, 'ladder_ledger_page', 1))
                        state.ladder_ledger_page = ledger_page
                        ...
                        with ui.column().classes('w-full max-w-[980px] mx-auto gap-3 items-center'):
                            with ui.card().classes('mq-card w-full p-5 md:p-6'):
                                with ui.row().classes('w-full items-start justify-between gap-3 max-[900px]:flex-wrap'):
                                    ...
                                    with ui.row().classes('gap-2 flex-wrap'):
                                        ...
                                        ledger_btn = ui.button('Ledger', on_click=lambda: (setattr(state, 'ladder_view', 'Ledger'), setattr(state, 'ladder_ledger_page', 1), request_render_refresh())).classes('mq-btn-secondary rounded-xl px-4 py-2 font-semibold')
                                        if current_ladder_view == 'Players':
                                            players_btn.classes('mq-btn-gold')
                                        elif current_ladder_view == 'Guilds':
                                            guilds_btn.classes('mq-btn-gold')
                                        else:
                                            ledger_btn.classes('mq-btn-gold')
                                if current_ladder_view in {'Players', 'Ledger'}:
                                    with ui.row().classes('w-full gap-2 mt-4 flex-wrap'):
                                        for ladder_mode in LADDER_MODE_ORDER:
                                            mode_btn = ui.button(ladder_mode, on_click=lambda mode=ladder_mode: (setattr(state, 'ladder_mode', mode), setattr(state, 'ladder_progression_page', 1), setattr(state, 'ladder_fastest_page', 1), setattr(state, 'ladder_fastest_class_page', 1), state.refresh_public_ladder(), state.refresh_public_pq_ledger(), request_render_refresh())).classes('mq-btn-secondary rounded-xl px-4 py-2 font-semibold')
                                            if current_ladder_mode == ladder_mode:
                                                mode_btn.classes('mq-btn-gold')
                                    if current_ladder_view == 'Players':
                                        with ui.row().classes('w-full gap-2 mt-2 flex-wrap'):
                                            progression_btn = ui.button('Progression', on_click=lambda: (setattr(state, 'ladder_player_view', 'Progression'), setattr(state, 'ladder_progression_page', 1), request_render_refresh())).classes('mq-btn-secondary rounded-xl px-4 py-2 font-semibold')
                                            fastest_overall_btn = ui.button('Fastest PQ', on_click=lambda: (setattr(state, 'ladder_player_view', 'Fastest PQ'), setattr(state, 'ladder_fastest_page', 1), request_render_refresh())).classes('mq-btn-secondary rounded-xl px-4 py-2 font-semibold')
                                            fastest_class_btn = ui.button('Fastest PQ by Class', on_click=lambda: (setattr(state, 'ladder_player_view', 'Fastest PQ by Class'), setattr(state, 'ladder_fastest_class_page', 1), request_render_refresh())).classes('mq-btn-secondary rounded-xl px-4 py-2 font-semibold')
                                            if current_player_view == 'Progression':
                                                progression_btn.classes('mq-btn-gold')
                                            elif current_player_view == 'Fastest PQ':
                                                fastest_overall_btn.classes('mq-btn-gold')
                                            else:
                                                fastest_class_btn.classes('mq-btn-gold')
                            ...
                            elif current_ladder_view == 'Ledger':
                                with ui.card().classes('mq-card w-full p-4 md:p-5'):
                                    ui.label(f'{current_ladder_mode} PQ Ledger').classes('text-xl font-semibold text-slate-100 mb-3')
                                    ui.label((state.public_pq_ledger_status or 'Every etched Prismatic Quest attempt appears here, newest first.')).classes('text-slate-300 leading-6 mb-3')
                                    if not ledger_rows_all:
                                        ui.label('No PQ attempts are etched for this mode yet.').classes('text-slate-300 leading-6')
                                    else:
                                        with ui.card().classes('mq-panel-frame w-full px-3 py-2 mb-2'):
                                            with ui.row().classes('w-full items-center gap-3 text-[11px] uppercase tracking-[0.14em] text-slate-400 font-semibold'):
                                                ui.label('When').classes('min-w-[170px] flex-[1.1]')
                                                ui.label('Player').classes('min-w-[160px] flex-1')
                                                ui.label('Class').classes('min-w-[150px] flex-1')
                                                ui.label('Result').classes('w-[70px] text-right')
                                                ui.label('Time').classes('w-[82px] text-right')
                                        for row in ledger_rows_page:
                                            with ui.card().classes('mq-panel-frame w-full px-3 py-2 mb-1'):
                                                with ui.row().classes('w-full items-center gap-3 flex-wrap'):
                                                    ui.label(format_completed_stamp(row.get('completed_at'))).classes('min-w-[170px] flex-[1.1] mq-detail-text')
                                                    ui.label(str(row.get('character_name') or 'Nameless Hero')).classes('min-w-[160px] flex-1 text-slate-100 font-semibold')
                                                    ui.label(str(row.get('player_class') or '')).classes('min-w-[150px] flex-1 mq-detail-text')
                                                    ui.label('PASS' if bool(row.get('passed', False)) else 'FAIL').classes('w-[70px] mq-detail-text text-right')
                                                    ui.label(format_duration(row.get('elapsed_seconds'))).classes('w-[82px] mq-detail-text text-right')
                                        if ledger_total_pages > 1:
                                            with ui.row().classes('w-full justify-end items-center gap-3 mt-3 flex-wrap'):
                                                ui.label(f'Page {ledger_page}/{ledger_total_pages}').classes('mq-detail-text')
                                                ui.select(ledger_page_options, value=ledger_page, on_change=lambda e: (setattr(state, 'ladder_ledger_page', int(e.value or 1)), request_render_refresh())).props('dense outlined').classes('w-[110px]')
                            else:
                                if current_player_view == 'Fastest PQ by Class':
                                    with ui.card().classes('mq-card w-full p-4 md:p-5'):
                                        ...
                                        if not fastest_class_rows_all:
                                            ui.label(f'No Prismatic Quest attempt times are etched for {available_fastest_class} in this mode yet.').classes('text-slate-300 leading-6')
                                        else:
                                            with ui.card().classes('mq-panel-frame w-full px-3 py-2 mb-2'):
                                                with ui.row().classes('w-full items-center gap-3 text-[11px] uppercase tracking-[0.14em] text-slate-400 font-semibold'):
                                                    ui.label('Rank').classes('w-[58px]')
                                            ...
                                            for row in fastest_class_rows_page:
                                                with ui.card().classes('mq-panel-frame w-full px-3 py-2 mb-1'):
                                                    with ui.row().classes('w-full items-center gap-3 flex-wrap'):
                                                        ui.label(f"#{int(row.get('rank', 0) or 0)}").classes('w-[58px] text-slate-400 font-semibold')
                                                        ui.label(str(row.get('character_name') or 'Nameless Hero')).classes('min-w-[180px] flex-[1.1] text-slate-100 font-semibold')
                                    ...
                                    with ui.card().classes('mq-card w-full p-4 md:p-5'):
                                        ui.label(f'{current_ladder_mode} Fastest PQ').classes('text-xl font-semibold text-slate-100 mb-3')
                                        ui.label('Best recorded clear per account in this mode.').classes('text-slate-300 leading-6 mb-3')
                                        if not fastest_rows_all:
                                            ui.label('No Prismatic Quest attempt times are etched for this mode yet.').classes('text-slate-300 leading-6')
                                        else:
                                            with ui.card().classes('mq-panel-frame w-full px-3 py-2 mb-2'):
                                                with ui.row().classes('w-full items-center gap-3 text-[11px] uppercase tracking-[0.14em] text-slate-400 font-semibold'):
                                                    ui.label('Rank').classes('w-[58px]')
                                                    ui.label('Character').classes('min-w-[180px] flex-[1.1]')
                                                    ui.label('Best Class').classes('min-w-[140px] flex-1')
                                                    ui.label('Time').classes('w-[82px] text-right')
                                                    ui.label('Lv').classes('w-[48px] text-right')
                                                    ui.label('').classes('w-[18px]')
                                            for row in fastest_rows_page:
                                                with ui.card().classes('mq-panel-frame w-full px-3 py-2 mb-1'):
                                                    with ui.row().classes('w-full items-center gap-3 flex-wrap'):
                                                        ui.label(f"#{int(row.get('rank', 0) or 0)}").classes('w-[58px] text-slate-400 font-semibold')
                                                        ui.label(str(row.get('character_name') or 'Nameless Hero')).classes('min-w-[180px] flex-[1.1] text-slate-100 font-semibold')
                                                        ui.label(str(row.get('highest_class') or '')).classes('min-w-[140px] flex-1 mq-detail-text')
                                                        ui.label(format_duration(row.get('fastest_pq_seconds'))).classes('w-[82px] mq-detail-text text-right')
                                                        ui.label(str(int(row.get('level', 1) or 1))).classes('w-[48px] mq-detail-text text-right')
                                                        ui.button(icon='visibility', on_click=lambda uid=str(row.get('user_id') or ''), name=str(row.get('character_name') or ''), mode=str(row.get('mode') or current_ladder_mode): open_public_profile_dialog(uid, name, 'ladder', mode)).props('flat round dense size=xs').classes('w-[18px] h-[18px] !text-[10px] text-slate-500 min-h-0 min-w-0 p-0')
                                            if fastest_total_pages > 1:
                                                with ui.row().classes('w-full justify-end items-center gap-3 mt-3 flex-wrap'):
                                                    ui.label(f'Page {fastest_page}/{fastest_total_pages}').classes('mq-detail-text')
                                                    ui.select(fastest_page_options, value=fastest_page, on_change=lambda e: (setattr(state, 'ladder_fastest_page', int(e.value or 1)), request_render_refresh())).props('dense outlined').classes('w-[110px]')
                                else:
                                    with ui.card().classes('mq-card w-full p-4 md:p-5'):
                            ...
                            with ui.row().classes('gap-2 mt-3 w-full justify-center flex-wrap'):
                                ui.button('Refresh Ladder', on_click=lambda: (state.refresh_public_ladder(), state.refresh_public_pq_ledger(), state.refresh_guild_leaderboard(), request_render_refresh())).classes('mq-btn-secondary rounded-xl px-5 py-3 font-semibold')
                        ...
                        with ui.column().classes('w-full gap-4'):
                            with ui.card().classes('mq-card mq-glossary-hero w-full p-6 md:p-7'):
                                ...
                                ui.label('The brass-bound ledger of Prismatic Quest, refreshed for the current build: drop rules, affix shaping, class restrictions, route risks, market rules, and progression notes in one polished place.').classes('mq-glossary-body leading-7 mt-2 max-w-[980px]')
                                with ui.row().classes('mq-glossary-chip-row mt-5'):
                                    for chip in [
                                        'Arena loot: disadvantage rolls',
                                        'Well of Evil: 50% shaped reward',
                                        'Unspawnables: Special Stall only',
                                        'Affix highs are intentionally rare',
                                        'Proficiency adds family-specific EE',
                                        'SSF / HC / Core ladders are split',
                                    ]:
                            ...
                            with ui.row().classes('w-full gap-4 items-stretch flex-wrap'):
                                ...
                                with ui.card().classes('mq-card mq-glossary-section flex-1 min-w-[340px] p-5'):
                                    ...
                                    ui.html(build_glossary_list_html([
                                        ...
                                        'Well of Evil rewards roll affixes with advantage, but shaped reward drops are only 50% after a winning ritual.',
                                ...
                                with ui.card().classes('mq-card mq-glossary-section flex-1 min-w-[340px] p-5'):
                                    ...
                                    ui.html(build_glossary_list_html([
                                        "Well of Evil: pay 10 gold and sacrifice one Common inventory item. After a winning ritual there is a 50% chance at a shaped reward that matches the offering's tier and type, and you return to the Well afterward.",
                                        'Wellspawn fights are stronger than arena fights and pay boosted XP.',
                                        'Marketplace stall 1 sells a cheap Fine utility piece, stall 2 sells premium rare goods, and the Special Stall is the only source of Unspawnable items. Bazaar sellers can hold up to 100 active listings and may reprice or remove unsold posts.',
                                        ...
                                        'SSF disables the Bazaar entirely. Core, SSF, and HC all keep separate ladder lanes.',
                                        'When you clear Prismatic Quest, equipped gear tries empty Saved Set slots first and only spills into inventory if those slots are full.',
                                    ])).classes('mt-4')
                        ...
                        with ui.column().classes('w-full gap-4'):
                            with ui.card().classes('mq-card w-full p-6 md:p-7'):
                                ui.label('Support PrismQuest-RPG').classes('text-3xl font-semibold text-slate-100 text-center')
                                ui.label('Thank you for playing PrismQuest-RPG. The game will always be free to play. If you enjoy the climb, sharing the game and supporting the project both help a ton.').classes('text-slate-200 text-lg md:text-2xl leading-8 md:leading-10 mt-4 text-center')
                                ui.label('No microtransactions. No paywalls. Just a better chance to keep building the world, the classes, the bosses, and the endgame.').classes('text-slate-400 text-sm md:text-base leading-6 mt-3 text-center')
                            with ui.row().classes('w-full gap-4 max-[980px]:flex-col'):
                                with ui.card().classes('mq-card flex-1 min-w-[300px] p-5 md:p-6'):
                                    ui.label('Support the Chronicle').classes('mq-inv-section-title mb-2')
                                    ui.label('If you want to help keep PrismQuest-RPG growing, Patreon is the cleanest way to back the project directly.').classes('mq-detail-text mb-4 leading-7')
                                    with ui.element('div').classes('mq-panel w-full p-4 rounded-2xl'):
                                        ui.label('Patreon').classes('text-xl font-semibold text-amber-200')
                                        ui.label('Help fund continued updates, polish, and server costs while keeping the game fully free to play.').classes('text-slate-300 leading-6 mt-2')
                                        with ui.link(target='https://patreon.com/PrismQuest_RPG?utm_medium=unknown&utm_source=join_link&utm_campaign=creatorshare_creator&utm_content=copyLink', new_tab=True):
                                            ui.button('Support on Patreon', icon='favorite').classes('w-full mq-btn-gold rounded-xl px-5 py-3 font-semibold mt-4')
                                with ui.card().classes('mq-card flex-1 min-w-[300px] p-5 md:p-6'):
                                    ui.label('Follow the Trail').classes('mq-inv-section-title mb-2')
                                    ui.label('Catch updates, clips, builds, patch notes, and whatever cursed loot the chronicle coughs up next.').classes('mq-detail-text mb-4 leading-7')
                                    with ui.column().classes('w-full gap-3'):
                                        with ui.link(target='https://www.youtube.com/@PrismQuest-RPG', new_tab=True):
                            ...
                            with ui.card().classes('mq-card w-full p-4'):
                                with ui.row().classes('gap-2 flex-wrap items-center justify-between max-[760px]:justify-start'):
                                    ui.label('Thank you for helping PrismQuest-RPG grow.').classes('text-slate-300')
                                    with ui.row().classes('gap-2 flex-wrap'):
                                        ui.button('Return to Town', on_click=lambda: (state.enter_town('You leave the donation board and step back into the square.'), request_render_refresh())).classes('mq-btn-gold rounded-xl px-5 py-3 font-semibold')
                                        ui.button('Return to Arena', on_click=lambda: (state.open_game_tab('arena'), request_render_refresh())).classes('mq-btn-secondary rounded-xl px-5 py-3 font-semibold')
                            return
                        ...
                        with ui.element('div').classes('mq-player-side-layout'):
                            ...
                            with ui.column().classes('gap-2 min-w-0 w-full'):
                                ...
                                def arena_core_stat_chip(stat_key: str, label: str, value: int) -> None:
                                    ...
                                    tooltip_html = build_core_stat_tooltip_html(player, stat_key)
                                    if can_allocate_here:
                ...
                with ui.card().classes('mq-arena-card w-full p-5'):
                    with ui.row().classes('mq-arena-options w-full'):
                        ...
                        auto_offset_options = {offset: f'-{offset}' for offset in range(0, max(1, int(player.level or 1)))}
                        state.arena_level_offset = max(0, min(int(getattr(state, 'arena_level_offset', 0) or 0), max(auto_offset_options.keys(), default=0)))
                        offset_select = ui.select(auto_offset_options, value=state.arena_level_offset, on_change=lambda e: setattr(state, 'arena_level_offset', int(e.value or 0))).props('dense outlined label=Auto Offset')
                        offset_select.classes('bg-transparent min-w-[120px]')
                        def _offset_change(e):
                            state.arena_level_offset = max(0, min(int(e.value or 0), max(auto_offset_options.keys(), default=0)))
                            if state.player is not None and state.arena_same_level:
                                state.arena_selected_level = max(1, int(state.player.level or 1) - int(state.arena_level_offset or 0))
                            request_render_refresh()
                        offset_select.on_value_change(_offset_change)
                        def _toggle_same(e):
                            state.arena_same_level = bool(e.value)
                            if state.player is not None and state.arena_same_level:
                                state.arena_selected_level = max(1, int(state.player.level or 1) - int(getattr(state, 'arena_level_offset', 0) or 0))
                            request_render_refresh()
                        same_level.on_value_change(_toggle_same)
                        if state.fight_in_progress:
                            same_level.disable()
                            offset_select.disable()
                        elif not state.arena_same_level:
                            offset_select.disable()
                        if state.arena_same_level:
                            offset_value = int(getattr(state, 'arena_level_offset', 0) or 0)
                            if offset_value > 0:
                                penalty_text = f'Hero Level - {offset_value} ({level_penalty}% lower-level XP penalty)'
                            else:
                                penalty_text = 'Hero Level'
                        else:
