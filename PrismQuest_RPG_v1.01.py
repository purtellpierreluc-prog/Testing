...
def build_glossary_text() -> str:
    ...
    lines.append("• Transmutation needs two items with the same tier, slot, and subtype. Gold cost = 2 + both items' total affix counts.")
                            ...
                            with ui.row().classes('w-full gap-4 items-stretch flex-wrap'):
                                ...
                                with ui.card().classes('mq-card mq-glossary-section flex-1 min-w-[340px] p-5'):
                                    ...
                                    ui.html(build_glossary_list_html([
                                        ...
                                        "Transmutation requires two items with the same tier, slot, and subtype. Gold cost = 2 + both items' total affix counts.",
