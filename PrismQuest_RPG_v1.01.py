...
def main_page(request: Request) -> None:
    ...
    @ui.refreshable
    def render_scene_tutorial_dialog() -> None:
        scene_key = state.scene_tutorial_open_key
        info = SCENE_TUTORIAL_CONTENT.get(scene_key, {})
        ...
        with scene_tutorial_dialog:
            with ui.card().classes('mq-card max-w-[900px] w-[95vw] p-7 md:p-8'):
                ui.label(title).classes('text-4xl md:text-5xl font-semibold text-slate-100')
                if lead:
                    ui.label(lead).classes('text-slate-300 text-xl md:text-2xl leading-9 mt-4')
                for line in body:
            ...
            with ui.card().classes('mq-card w-full p-5'):
                with ui.row().classes('w-full items-start justify-between gap-4 max-[1100px]:flex-wrap'):
                    ...
                    with ui.row().classes('gap-2 flex-wrap'):
                        ...
                        ui.button('Tutorial', on_click=lambda: (state.open_scene_tutorial('inventory'), request_render_refresh())).classes('mq-btn-gold rounded-lg')
    ...
    refresh_state = {'pending': False, 'last_at': 0.0}
    ...
    def request_render_refresh(*_args, force: bool = False, delay: float = 0.0) -> None:
        ...
        if wait <= 0.0:
            ...
            ui.timer(wait, _flush, once=True)
    ...
    def render() -> None:
        ...
        with ui.column().classes(f'mq-page mq-screen-{screen_class} mq-scene-{scene_class} w-full items-center px-4 py-5 md:px-6 lg:px-8'):
                ...
                with ui.row().classes('mq-shell w-full items-stretch gap-6 no-wrap max-[1200px]:flex-wrap'):
                    ...
                    with ui.column().classes('mq-title-side-stack w-full max-w-[470px] gap-4'):
                        ...
                        with ui.card().classes('mq-side-card p-4'):
                            ...
                            ui.label('Community Server').classes('mq-panel-caption mt-4')
            ...
            if state.screen == 'town':
                ...
                render_scene_tutorial_dialog.refresh()
                if state.scene_tutorial_open_key:
            ...
            async def handle_fight() -> None:
                await state.queue_arena_encounter_async(request_render_refresh)
            async def handle_rest() -> None:
                await state.rest_async(request_render_refresh)
            ...
            with ui.column().classes('mq-arena-shell w-full gap-4'):
                    ...
                    if state.game_tab == 'inventory':
                        ...
                        with ui.column().classes('w-full gap-4'):
                            with ui.card().classes('mq-card w-full p-5'):
                                ...
                                with ui.row().classes('gap-2 mt-4 flex-wrap'):
                                    ...
                                    ui.button('Tutorial', on_click=lambda: (state.open_scene_tutorial('bazaar'), request_render_refresh())).classes('mq-btn-secondary rounded-xl px-5 py-3 font-semibold')
                                ...
                                with ui.column().classes('flex-1 min-w-[380px] gap-3'):
                                    ...
                                    def render_marketplace_offer_list() -> None:
                                        ...
                                        with ui.card().classes('mq-card w-full p-4'):
                                            ui.label('Routes').classes('mq-inv-section-title mb-3')
                                            with ui.row().classes('gap-2 flex-wrap'):
                                                ui.button('Tutorial', on_click=lambda: (state.open_scene_tutorial('marketplace'), request_render_refresh())).classes('mq-btn-secondary rounded-xl px-5 py-3 font-semibold')
                                                ui.button('Return to Arena', on_click=lambda: (state.open_game_tab('arena'), request_render_refresh())).classes('mq-btn-gold rounded-xl px-5 py-3 font-semibold')
                                ...
                                with ui.card().classes('mq-card flex-1 min-w-[360px] p-5 h-full'):
                                    ...
                                    with ui.card().classes('mq-panel-frame p-4 mt-4'):
                                        ...
                                        if first_item is None or second_item is None:
                                            ...
                                            ui.label('\n'.join(lines)).classes('mq-detail-text mt-2')
                                    with ui.row().classes('gap-2 mt-4 flex-wrap'):
                                        ui.button('Tutorial', on_click=lambda: (state.open_scene_tutorial('transmute'), request_render_refresh())).classes('mq-btn-secondary rounded-xl px-5 py-3 font-semibold')
                                ...
                                with ui.column().classes('flex-1 min-w-[380px] gap-4'):
                                    with ui.card().classes('mq-card w-full p-4'):
                                        ...
                                        with ui.row().classes('gap-2 mt-4 flex-wrap'):
                                            ...
                                            ui.button('Tutorial', on_click=lambda: (state.open_scene_tutorial('well'), request_render_refresh())).classes('mq-btn-secondary rounded-xl px-5 py-3 font-semibold')
                        ...
                        with ui.column().classes('w-full gap-4'):
                            ...
                            with ui.card().classes('mq-card w-full p-4'):
                                ...
                                with ui.row().classes('gap-2 mt-4 flex-wrap'):
                                    ui.button('Tutorial', on_click=lambda: (state.open_scene_tutorial('ladder'), request_render_refresh())).classes('mq-btn-secondary rounded-xl px-5 py-3 font-semibold')
                ...
                with ui.card().classes('mq-arena-card w-full p-5'):
                    ...
                    with ui.row().classes('mq-arena-buttons w-full mt-4'):
                        ...
                        ui.button('Tutorial', on_click=lambda: (state.open_scene_tutorial('arena'), request_render_refresh())).classes('mq-arena-btn secondary')
